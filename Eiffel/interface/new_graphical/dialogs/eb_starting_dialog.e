note
	...
	date		: "$Date: 2009-05-25 17:33:54 +0800 (Mon, 25 May 2009) $"
	revision	: "$Revision: 78854 $"
...
--			debug ("ui_testing")
				ok_button.set_identifier_name ("start dialog ok")
				cancel_button.set_identifier_name ("start dialog cancel")
--			end
