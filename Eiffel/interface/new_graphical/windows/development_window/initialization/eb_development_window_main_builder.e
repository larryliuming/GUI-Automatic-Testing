note
	...
	date		: "$Date: 2009-04-17 11:24:55 +0800 (Fri, 17 Apr 2009) $"
	revision	: "$Revision: 78284 $"
...
--			build_customized_tools
	...
	build_vision_window
		...
		do
			...
			--debug ("ui_tesing") -- enable debug not work!?
				l_window.set_identifier_name ("developemnt window")
			--end
